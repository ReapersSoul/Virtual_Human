...
struct ImDrawList
{
    ...
    IMGUI_API void  AddPolyline(const ImVec2* Data, int num_points, ImU32 col, ImDrawFlags flags, float thickness);
    IMGUI_API void  AddConvexPolyFilled(const ImVec2* Data, int num_points, ImU32 col); // Note: Anti-aliased filling requires points to be in clockwise order.
